...
- *[`xGSsimulator`](http://rawgit.com/hfang-bristol/Pi/master/inst/xGSsimulator.html)*: simulates the gold standard negatives from gold standard positives (GSP) based on the interaction netwok.

## Integral functions (under development)
...
- *[`xMLplot`](http://rawgit.com/hfang-bristol/Pi/master/inst/xMLplot.html)*: visualise machine learning results (an `pTarget` object) and returns an object of class `ggplot`.
