...
Spondyloarthritis-associated GWAS lead SNPs are collected mainly from GWAS Catalog, complemented by [ImmunoBase](http://www.immunobase.org) and latest publications. 
...
dev.off()
```
```{r fig.width=10, fig.height=5, fig.align="center", echo=FALSE, eval=TRUE}
library(png)
library(grid)
